...
extern "C" {
	JNIEXPORT void Java_net_tensory_djscratch_MainActivity_SuperpoweredExample(JNIEnv *javaEnvironment, jobject self, jstring apkPath, jlongArray offsetAndLength);
	JNIEXPORT void Java_net_tensory_djscratch_MainActivity_onPlayPause(JNIEnv *javaEnvironment, jobject self, jboolean play);
	JNIEXPORT void Java_net_tensory_djscratch_MainActivity_onCrossfader(JNIEnv *javaEnvironment, jobject self, jint value);
	JNIEXPORT void Java_net_tensory_djscratch_MainActivity_onFxSelect(JNIEnv *javaEnvironment, jobject self, jint value);
	JNIEXPORT void Java_net_tensory_djscratch_MainActivity_onFxOff(JNIEnv *javaEnvironment, jobject self);
	JNIEXPORT void Java_net_tensory_djscratch_MainActivity_onFxValue(JNIEnv *javaEnvironment, jobject self, jint value);
}
...
JNIEXPORT void Java_net_tensory_djscratch_MainActivity_SuperpoweredExample(JNIEnv *javaEnvironment, jobject self, jstring apkPath, jlongArray params) {
